    ...
    <div class="container">
        <header class="pb-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4">JG BOOKSHOP</span>
            </a>
        </header>
        ...
        <button data-bs-toggle="modal" data-bs-target="#cartModal"
            class="btn btn-danger btn-block btn-lg mx-auto float">Your Cart Total Ksh. <span id="cartValue">0.00</span></button>
